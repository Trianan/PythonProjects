# BUDGETING SOFTWARE Version 0.1 (Alpha)
# This section adds a deposit value, and records the amount before dividing it into separate budgets.
deposit_raw = input("Deposit: $")
deposit_history = []
deposit_history.append(deposit_raw)
print(deposit_history)  # Displays deposit_history list, while continuing to work with value.

# This section divides the raw value into separate budgets, defines a history-list, and displays each budget.
