...
class Scoreboard:
    ...
    def prep_images(self):
        """Render all images to be drawn to the scoreboard."""
    ...
    def check_high_score(self):
        ...
        if self.stats.score > self.stats.high_score:
            ...
            # Play high-score noise:
            if self.stats.new_high_score < 1:
                high_score_noise = mixer.Sound('sounds/high_score.wav')
                high_score_noise.play()
    ...
    def show_score(self):
        """Draw the score, level, and ships remaining to the screen."""
